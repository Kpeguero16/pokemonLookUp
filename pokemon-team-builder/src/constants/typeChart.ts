...
/**
 * The 18x18 Pokemon type effectiveness chart (as of Gen 6+).
 * typeChart[attackingType][defendingType] = damage multiplier
 * Values: 0 (immune), 0.5 (not very effective), 1 (normal), 2 (super effective)
 */
export const TYPE_CHART: Record<PokemonTypeName, Record<PokemonTypeName, number>> = {
  normal: {
