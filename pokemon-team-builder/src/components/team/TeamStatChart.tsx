...
export function TeamStatChart({ team }: TeamStatChartProps) {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-5 w-full">
      <h3 className="text-center text-sm font-semibold text-slate-500 uppercase tracking-wide mb-2">
        Team Average Stats
      </h3>
      <StatRadarChart stats={avg} color="#f59e0b" />
      <div className="grid grid-cols-3 gap-2 mt-3 text-center text-xs text-slate-500">
