  ...
  return (
    <div className="flex flex-col items-center gap-6 py-8 px-4 min-h-screen bg-slate-50">
      <div className="text-center">
        <h1 className="text-4xl font-extrabold text-slate-800 tracking-tight">My Team</h1>
        <p className="text-slate-400 mt-1">Build your team and analyze its strengths</p>
      </div>
        ...
        {teamCount > 0 && (
          <>
            <div className="border-t border-slate-200 pt-2">
              <h2 className="text-lg font-bold text-slate-700 mb-3">Team Analysis</h2>
